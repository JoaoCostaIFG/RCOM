...
O cabeçalho de cada trama é protegida um BCC. As tramas de informação têm um
...
Este protocolo faz uso de uma máquina de estados de modo a conseguir recuperar
de situações de erro e saber o que fazer com a informação recebida.
